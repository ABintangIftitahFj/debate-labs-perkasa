...
class User(Base):
    ...
    student_profile: Mapped["StudentProfile | None"] = relationship("StudentProfile", back_populates="user")
    coach_profile: Mapped["CoachProfile | None"] = relationship("CoachProfile", back_populates="user")    
